...
const ASSET_PREFIX: &str = "EchoMusic-Lyrics-WinIsland-Windows";
...
mod tests {
    ...
    fn asset_name_uses_release_arch_names() {
        assert_eq!(
            ...
            Some("EchoMusic-Lyrics-WinIsland-Windows-AMD64.exe")
        );
        assert_eq!(
            expected_asset_name_for_arch("aarch64").as_deref(),
            Some("EchoMusic-Lyrics-WinIsland-Windows-ARM64.exe")
        );
    }
}
